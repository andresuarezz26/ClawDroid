...
## 9. Gradle Module Setup

```kotlin
// settings.gradle.kts
include(":app", ":domain", ":data", ":framework")
```

```kotlin
// domain/build.gradle.kts
// PURE KOTLIN — no Android plugin
plugins {
    kotlin("jvm")
...
dependencies {
    ...
    implementation("javax.inject:javax.inject:1")  // for @Inject without Android
